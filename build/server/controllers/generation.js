...
export const handleGenerateDocuments = async (req, res) => {
...
export const handleApplicationAnalysis = async (req, res) => {
...
const generateTailoredDocuments = async (profile, options) => {
    if (!hasGeminiKey) {
        const mockAnalysis = {
            fitScore: 85,
...
const analyzeApplicationFit = async (resumeText, jobDescription) => {
    if (!hasGeminiKey) {
        return {
            fitScore: 80,
